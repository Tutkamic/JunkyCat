...
{
	{
		// transform.position += new Vector3(0f, 0f, playerScript.playerInputScript.catAndCamMoveSpeed * camConstantSpeed * playerScript.playerMovementScript.forwardSpeedFactor * playerScript.playerMovementScript.levelFactor) * Time.deltaTime;
...
IL_007a:
	{
		...
		// levelSpeedFactor = 3;
		__this->___levelSpeedFactor_11 = (3.0f);
		// break;
		goto IL_00ce;
	}
